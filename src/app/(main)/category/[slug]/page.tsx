  ...
  return (
    <div className="max-w-2xl mx-auto w-full py-6 px-4 sm:px-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-6 mb-8 flex flex-col items-center justify-center text-center">
        <div className="w-12 h-12 bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-300 rounded-full flex items-center justify-center mb-3">
      ...
      {articles.length === 0 ? (
        <div className="text-center text-gray-500 py-10 bg-white dark:bg-gray-950 rounded-xl border border-gray-100 dark:border-gray-800">
          No articles published in {formattedCategory} yet. Check back soon!
        </div>
      ) : (
